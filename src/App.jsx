...
const STORAGE_KEY = "client-orders-v1";
...
const SERVICES = [
  ...
  },
  {
    id: "video",
    name: "Montage vidéo",
    description: "Montage de vidéos pour réseaux sociaux, publicité ou présentation.",
    price: 20000,
  },
  {
    id: "reseaux",
    name: "Gestion réseaux sociaux",
    description: "Création et organisation de contenus pour vos réseaux sociaux.",
    price: 30000,
  },
  {
    id: "autre",
...
export default function App() {
  ...
  function submitOrder(event) {
    ...
    const order = {
      ...
      amount: Number(form.amount || selectedService?.price || 0),
  ...
  function trackOrder(event) {
    ...
    const result = orders.find(
      (order) => order.orderNumber.toUpperCase() === number
    );

    setTrackingResult(result || false);
  }
    ...
    <div className="app">
      <header className="header">
        <div className="container header-inner">
          ...
          <nav className={`nav ${mobileMenu ? "nav-open" : ""}`}>
            ...
            <button onClick={openTracking}>Suivre commande</button>
              ...
              <div className="container hero-grid">
                ...
                <div className="video-card">
                  <div className="video-placeholder">
                    ...
                    <span>Vidéo disponible prochainement</span>
                  </div>
                </div>
              </div>
            </section>
                ...
                <div className="form-section">
                  ...
                  <div className="notice">
                    ...
                    <div>
                      ...
                      <p>
                        Le paiement en ligne sécurisé sera connecté dans une
                        prochaine étape.
                      </p>
                    </div>
                  </div>
          ...
          <section className="section page-section">
            <div className="container narrow">
              <div className="success-card">
                ...
                <p>
                  Conservez précieusement votre numéro de commande pour suivre
                  son avancement.
                </p>
                ...
                <div className="order-summary">
                  ...
                  <div>
                    <span>Montant</span>
                    <strong>{formatMoney(lastOrder.amount)}</strong>
                  </div>
                ...
                <div className="success-actions">
                  <button
                    ...
                    onClick={() => {
                      setTrackingNumber(lastOrder.orderNumber);
                  ...
                  <button className="secondary-button" onClick={openHome}>
                    Retour à l'accueil
                  </button>
                </div>
              </div>
          ...
          <section className="section page-section">
            <div className="container narrow">
              <div className="page-title">
                ...
                <p>
                  Entrez le numéro reçu après votre commande.
                </p>
              </div>
              ...
              {trackingResult === false && (
                <div className="not-found">
                  ...
                  <p>
                    Vérifiez le numéro de commande puis réessayez.
                  </p>
                </div>
              )}

              {trackingResult && (
                <TrackingCard order={trackingResult} />
              )}
            </div>
          </section>
        )}
      ...
      <footer className="footer">
        <div className="container footer-inner">
          <div>
            <strong>Prestations Online</strong>
            <p>Plateforme de prestations à la demande.</p>
          </div>

          <div>
            <span>Commande simple • Suivi • Livraison</span>
          </div>
        </div>
      </footer>
    </div>
